...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Clase Animacion", nullptr, nullptr);
	...
	Model Mymodel2((char*)"Models/spyder/spyder.obj");
	...
	GLfloat vertices[] =
	{
		...
		0.5f, -0.5f, -0.5f,     0.0f,  0.0f, -1.0f,     0.25f, 0.25f,
		0.5f,  0.5f, -0.5f,     0.0f,  0.0f, -1.0f,     .25f, 0.25f,
   ...
   GLuint  VAOanim;
	...
	// Diffuse map
	image = stbi_load("images/perrito.png", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint viewPosLoc = glGetUniformLocation(animShader.Program, "viewPos");
		...
		glUniform1f(glGetUniformLocation(animShader.Program, "time"), t);
	    ...
	    glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Mymodel.Draw(animShader);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(5.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Mymodel2.Draw(animShader);
...
// Movesalters the camera positions based on user input
void DoMovement()
{
